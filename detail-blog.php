        ...
        <div id="nav">
            ...
            <div id="nav-fixed">
                <div class="container">
                    <!-- logo -->
                    <div class="nav-logo">
                        <a href="index.html" class="logo"><img src="assets/template/webmag/img/logo.png" alt=""></a>
                    </div>
                    <!-- /logo -->
                ...
                <div class="col-md-8">
                    <div class="section-row sticky-container">
                        <div class="main-post">
                            ...
                            <figure class="figure-img">
                                <img class="img-responsive" src="assets/template/webmag/img/post-4.jpg" alt="">
                    ...
                    <div class="section-row text-center">
                        <a href="#" style="display: inline-block;margin: auto;">
                            <img class="img-responsive" src="assets/template/webmag/img/ad-2.jpg" alt="">
                        </a>
                    </div>
                    <!-- ad -->
                        ...
                        <div class="post-author">
                            <div class="media">
                                <div class="media-left">
                                    <img class="media-object" src="assets/template/webmag/img/author.png" alt="">
                                </div>
                    ...
                    <div class="section-row">
                        ...
                        <div class="post-comments">
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <img class="media-object" src="assets/template/webmag/img/avatar.png" alt="">
                                </div>
                                <div class="media-body">
                                    <div class="media-heading">
                                        <h4>John Doe</h4>
